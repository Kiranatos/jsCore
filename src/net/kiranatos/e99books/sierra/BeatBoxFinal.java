...
public class BeatBoxFinal {
    ...
    String[] instrumentNames = {"Bass Drum","Closed Hi-Hat","Open Hi-Hat",
        ...
        "Maracas","Whisle","Low Conga","Cowbell","Vibraslap","Low-mid Tom",
        "High Agogo","Open Hi Conga"};
    int[] instruments = {35,42,46,38,49,39,50,60,70,72,64,56,58,47,67,63};
    
    public static void main(String[] args) {
        new BeatBoxFinal().startUp("SomeName");
    }
    ...
    public void buildGUI(){
        ...
        incomingList.setListData(listVector); //No begining data
        ...
        for (int i=0; i<16; i++) {
            ...
            for (int j=0; j<16; j++) {
                ...
                if (jc.isSelected()) {
                    ...
                    trackList.add(null); //this slot must be empty
                }
            }
